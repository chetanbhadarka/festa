...
public class UserProfileRecyclerAdapter extends FirebaseRecyclerAdapter<UserProfileModal, UserProfileRecyclerAdapter.MyHolder> {
    private Context context;

    public UserProfileRecyclerAdapter(@NonNull FirebaseRecyclerOptions<UserProfileModal> options, Context context) {
        super(options);
        this.context = context;
    }

    @Override
    protected void onBindViewHolder(@NonNull MyHolder holder, int position, @NonNull UserProfileModal model) {
        Glide
